                     ...
                     <div class="row">
                           <div class="col-lg-6">
                              <div class="hero__text">
                                 ...
                                 <h2>Daftar dan akses koleksi digital kami secara gratis.</h2>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="img/trending/fiksi.jpg">
                                    </div>
                                    <div class="product__item__text">
                                        <ul>
                                            <li>Movie</li>
                                        </ul>
                                        <h5><a href="#">Ocean's Desire</a></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
